...
// sharper reason here. checkNotificationRateLimit spent the slot up front, so a
// DM that then failed to open or failed to post still cost the recipient one.
